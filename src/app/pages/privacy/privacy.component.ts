      ...
      <div class="container" style="max-width: 900px;">
        ...
        <article class="card glass-card" style="background: rgba(30, 41, 59, 0.6); border: 1px solid rgba(56, 189, 248, 0.2); padding: 36px; border-radius: 16px; color: #cbd5e1; line-height: 1.7; font-size: 0.95rem;">
          ...
          <section style="margin-bottom: 28px;">
            ...
            <p style="margin-top: 8px;">Все платежные операции проводятся через защищенные соединения авторизованными платежными агрегаторами (включая RollyPay). Реквизиты банковских карт и данные платёжных средств не хранятся на серверах SamuraiWorld.</p>
          </section>
