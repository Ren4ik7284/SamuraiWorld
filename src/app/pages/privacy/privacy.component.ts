      ...
      <div class="container" style="max-width: 900px;">
        ...
        <article class="card glass-card" style="background: rgba(22, 12, 16, 0.85); border: 1px solid rgba(212, 160, 23, 0.25); padding: 36px; border-radius: 16px; color: #cbd5e1; line-height: 1.7; font-size: 0.95rem;">
          ...
          <section style="margin-bottom: 28px;">
            ...
            <p style="margin-top: 8px;">Все платежные операции проводятся через защищенные соединения авторизованными платежными агрегаторами (через шлюз Coinso). Реквизиты банковских карт и данные платёжных средств не хранятся на серверах SamuraiWorld.</p>
          </section>
